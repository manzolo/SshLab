...
scelta=$(edu_rand_pick 910 "$@")
install -d -m 700 -o manzolo -g manzolo "$LAB/backup-2019"
install -m 600 -o manzolo -g manzolo "/opt/lab/keys/ed25519/$scelta" "$LAB/backup-2019/id_ed25519"
...
lab_fp "/opt/lab/keys/ed25519/$scelta.pub" > "$LAB_STATE/fp_backup"
lab_log_azzera
